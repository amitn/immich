import { findColumns, splitAtPrices } from 'src/utils/collections/layout.js';
import {
  OcrBoxInput,
  TextLine,
  deskewBoxes,
...
/** an item of a menu: its name as printed in the language of the menu, its description, price and section */
export type MenuItem = SourceEntry;

export type ParsedMenu = ParsedSource;
 ...
 */
export const parseMenu = (ocr: OcrBoxInput[], options: SourceParseOptions = {}): ParsedMenu => {
